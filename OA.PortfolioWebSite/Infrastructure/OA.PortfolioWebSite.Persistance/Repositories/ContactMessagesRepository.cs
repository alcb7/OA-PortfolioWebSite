...
{
    public class ContactMessagesRepository : Repository<ContactMessages>, IContactMessagesRepository
    {
        public ContactMessagesRepository(DataAPIDbContext context) : base(context)
        {
        }
    }
}
